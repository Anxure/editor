<template>
  <div class="umo-ribbon-menu">
    <div v-if="menus.length > 1" class="umo-ribbon-tabs">
      <div v-for="item in menus" :key="item.value" class="umo-ribbon-tabs-item" :class="{ active: currentMenu === item.value }" @click="changeMenu(item.value)">
        {{ item.label }}
      </div>
    </div>
    <toolbar-scrollable ref="scrollableRef" class="umo-scrollable-container">
      <div class="umo-ribbon-container">
        <template v-if="currentMenu === 'base'">
          ...
          <div class="umo-virtual-group">
            <div class="umo-virtual-group-row">
              <menus-toolbar-base-ordered-list v-if="!disableMenu('ordered-list')" />
          ...
          <div class="umo-virtual-group">
            ...
            <menus-toolbar-base-full-text-correction v-if="!disableMenu('full-text-correction')" />
          </div>
          <div class="umo-virtual-group">
        ...
        <template v-if="currentMenu === 'insert'">
          <div class="umo-virtual-group">
            ...
            <menus-toolbar-insert-chinese-date v-if="!disableMenu('chinese-date')" />
        ...
        <template v-if="currentMenu === 'tools'">
          ...
          <div class="umo-virtual-group">
            <menus-toolbar-tools-chinese-case v-if="!disableMenu('chinese-case')" />
          </div>
          <div class="umo-virtual-group">
